...
def get_train_data(input_file):
    """
    get train data fot LFM model train
    Args:
       input file:user item rating file
    Return:
       a list:[(userid,itemid,label),(userid,itemid1,label)]
    :param input_file:
    :return:
    """
    if not os.path.exists(input_file):
...
if __name__ == "__main__":
    ...
    print(item_dict["1"])
    print(item_dict["11"])
    score_dict = get_ave_score("C:/Users/hushe/Desktop/推荐系统/ml-1m/ratings.txt")
    print(len(score_dict))
    print(score_dict)
    print(score_dict['31'])
    train_data = get_train_data("C:/Users/hushe/Desktop/推荐系统/ml-1m/ratings.txt")
